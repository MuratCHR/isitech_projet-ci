...
<nav class="navbar navbar-expand-md navbar-dark fixed-top " style="background-color: #3f51b5">
    <div class="container-fluid">
        <a class="navbar-brand"><img src="https://i.imgur.com/tlZ0n4q.png" width="30" height="30" /></a>
        ...
        <div class="user_card bg-primary">
            ...
            <div class="mt-4">
                <div class="d-flex justify-content-center links text-light">
                    Vous n'avez pas de compte ? <a href="../user/creationUser" class="ml-2 text-danger"><b>En créer un</b></a>
                </div>
            </div>
        </div>
    </div>
